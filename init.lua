...
require('lazy').setup({
  ...
  {
    --weirdly taking precedence by default
...
vim.keymap.set("n", "<leader>l", function() harpoon:list():add() end, { desc = "Add to harpoon" })
...
-- I would really like this to wrap around, neeed to fix
